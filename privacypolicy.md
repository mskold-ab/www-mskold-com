...
We are committed to protecting the security of your information. For that reason we only storing your data inside Microsoft VSTS/TFS using Microsoft's API for storing extension data in your account. The data is stored in your account/server and is only accessible by member of your accounts.
