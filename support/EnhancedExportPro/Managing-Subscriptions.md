...
### 3. Assign users to your subscription
Once purchased, you need to assign users to your subscription. You can change the assigned users at any time.
![](./img/subscription_page.png)

You can either search for users (part of any team in any project) or approve requests from users requesting a license.

**Auto-approval of license requests**
Subscription owners can also turn on auto-approval for licensing requests on the settings tab. By doing so, the need for manual intervention when assigning a user to a license is removed.
With auto-approval turned on, unlicensed users requesting a license will be directly assigned a license and taken to the export tab, provided that the subscription has available users to assign.
