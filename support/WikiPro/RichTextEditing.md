...
description: "Azure DevOps WikiPRO extends the standard Azure DevOps Wiki experience by providing a rich text editor that enables users to create, edit, and format documentation in a familiar…"
menu: Rich Text Editor
toc: true
---
## Introduction
Azure DevOps WikiPRO extends the standard Azure DevOps Wiki experience by providing a rich text editor that enables users to create, edit, and format documentation in a familiar word style experience, without requiring extensive Markdown knowledge.
The rich text editor simplifies content authoring through an intuitive toolbar, allowing teams to create professional documentation faster while maintaining compatibility with Azure DevOps Wiki pages.
