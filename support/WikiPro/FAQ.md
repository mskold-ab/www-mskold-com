...
WikiPRO supports flowcharts, sequence diagrams, class diagrams, state diagrams, ER diagrams, user journeys, gantt charts, pie charts, quadrant charts, requirement diagrams, git graphs, C4 diagrams, mind maps, timelines, ZenUML, Sankey, XY charts, block diagrams, packet diagrams, kanban boards, architecture diagrams, and radar/treemap charts. See [Supported diagram types](./f-mermaid.md#supported-diagram-types).
...
Mermaid diagrams are useful for application architecture, deployment workflows, CI/CD pipelines, business processes, system integrations, database relationship diagrams, and project timelines. See [Using Mermaid in Documentation](./f-mermaid.md#using-mermaid-in-documentation).
